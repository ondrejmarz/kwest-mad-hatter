...
export const cs = {
  ...
  players: {
    ...
    subtractCoins: 'Odečíst mince',
    addCoins: 'Přidat mince',
  ...
  ledger: {
    ...
    historyTitle: 'Historie mincí',
    tasksCompleted: 'Splněné úkoly',
    rewardsWon: 'Získané odměny',
    coinsEarned: 'Vydělané mince',
    coinsSpent: 'Utracené mince',
    openingBalance: 'Počáteční zůstatek',
    empty: 'Zatím žádné transakce.',
    taskCompleted: 'Splněno: {name}',
    taskFailed: 'Nesplněno: {name}',
    taskNoPick: 'Nevybraný úkol',
    rewardBought: 'Odměna: {name}',
    punishBought: 'Trest: {name}',
    adjust: 'Úprava organizátorem',
    day: 'Den {day}',
  },
  tasks: {
    ...
    hasInterestCount: 'Má zájemce ({count})',
  ...
  todayPick: {
    chip: 'Dnešní dvojice',
    youInvited: 'Pozval(a) si {name} na dnešní úkol „{task}“',
  ...
  rewards: {
    ...
    bidLimitReached: 'Už máš dnešní maximum {max} přihozených odměn.',
  ...
  catalog: {
    ...
    taskColumns:
      'Název · Popis · Obtížnost · štítky… (štítek „2" nebo „2-4" určí dvojici/skupinu; text jako cs|en|de)',
