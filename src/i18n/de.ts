...
export const de: Dictionary = {
  ...
  players: {
    ...
    subtractCoins: 'Münzen abziehen',
    addCoins: 'Münzen hinzufügen',
    ...
    myBid: 'Deine Gebote auf Belohnungen',
  ...
  ledger: {
    ...
    historyTitle: 'Münzverlauf',
    tasksCompleted: 'Erledigte Aufgaben',
    rewardsWon: 'Gewonnene Belohnungen',
    coinsEarned: 'Verdiente Münzen',
    coinsSpent: 'Ausgegebene Münzen',
    openingBalance: 'Anfangsstand',
    empty: 'Noch keine Transaktionen.',
    taskCompleted: 'Erledigt: {name}',
    taskFailed: 'Nicht geschafft: {name}',
    taskNoPick: 'Keine Aufgabe gewählt',
    rewardBought: 'Belohnung: {name}',
    punishBought: 'Strafe: {name}',
    adjust: 'Anpassung durch Organisator',
    day: 'Tag {day}',
  },
  tasks: {
    ...
    takenChip: 'Vergeben',
    hasInterest: 'Gefragt',
    hasInterestCount: 'Gefragt ({count})',
  ...
  catalog: {
    ...
    taskColumns:
      'Name · Beschreibung · Schwierigkeit · Schlagwörter… (ein Tag „2" oder „2-4" macht Paar/Gruppe; Text als cs|en|de)',
